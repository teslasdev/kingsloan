      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex  gap-4 items-start">
            ...
            />
            <p className="text-[14px] font-[400] text-[#2E302E]">
              By proceeding, you agree to our Terms and Conditions, authorise us
              to verify your personal and financial information, understand that
              loan approval is subject to eligibility and credit assessment,
              acknowledge that failure to repay may result in legal action,
              accept that defaulting can affect your creditworthiness, and
              consent to our data privacy, processing, and repayment policies.
            </p>
          </div>
        </div>
      </div>
