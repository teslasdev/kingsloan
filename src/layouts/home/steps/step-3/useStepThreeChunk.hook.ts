...
export const useStepThreeChunk = (props: any) => {
  ...
  const form = useForm({
    initialFormData: {
      email: props.p.application.email || "",
      phoneNumber: props.p.application.phoneNumber || "",
      addressNumber: props.p.application.addressNumber || "",
      fullAddress: props.p.application.fullAddress || "",
      referee1firstName: props.p.application.referee1firstName || "",
      referee1lastName: props.p.application.referee1lastName || "",
      referee1PhoneNumber: props.p.application.referee1PhoneNumber || "",
      referee1Relationship: props.p.application.referee1Relationship || "",
      referee2firstName: props.p.application.referee2firstName || "",
      referee2lastName: props.p.application.referee2lastName || "",
      referee2PhoneNumber: props.p.application.referee2PhoneNumber || "",
      referee2Relationship: props.p.application.referee2Relationship || "",
    },
